...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("Inventory", policy => policy.RequireClaim("Department", "InventoryManagment"));
    ...
    options.AddPolicy("Productions", policy => policy.RequireClaim("Department", "ProductionManagment"));
});
